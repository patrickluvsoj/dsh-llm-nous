/**
 * Nous Portal OpenAI-compatible chat-completions wire format. Types only.
 *
...
export interface WireRequest {
  ...
  /** Reasoning effort for models that expose this OpenAI-compatible field. */
...
export interface WireDelta {
  ...
  content?: string | null
  /** OpenAI-compatible reasoning text; the first empty delta does not open a block. */
