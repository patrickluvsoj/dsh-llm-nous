...
export async function* translate(payloads: AsyncIterable<string>): AsyncGenerator<StreamChunk> {
  ...
  function* flushFinal(): Generator<StreamChunk> {
  ...
  // EOF without [DONE]: the Nous Portal and other OpenAI-compatible gateways
  // close the stream after the finish chunk without a sentinel. Finalize only
  // when a finish_reason was actually observed; a bare EOF is a truncated
  // response and stays an error.
