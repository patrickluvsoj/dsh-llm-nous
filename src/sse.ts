...
export async function* parseSse(
  ...
  // close the stream after the finish chunk without a sentinel. Do not raise
  // here — the consumer owns final-flush policy and raises STREAM_CLOSED
  // itself when no finish_reason was observed (a genuine truncation).
}
